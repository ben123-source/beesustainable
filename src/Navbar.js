    ...
    return(
        <div>
            <div className='bg-[#FFF3AC] w-screen h-20  flex justify-between items-center'>
                ...
                <button onClick={() => navigate("/")} className='text-2xl text-black hover:underline'> BeeSustainable </button> 
                </div>
                ...
                <ul className='flex gap-6 mr-4'>
                    ...
                    <button onClick={() => navigate("/tracker")} className='hover:underline text-black hover:cursor=pointer'>Tracker</button>
